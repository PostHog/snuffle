DROP TABLE IF EXISTS logs34_to_resource_attributes3 SYNC;
DROP TABLE IF EXISTS logs34_to_log_attributes3 SYNC;
...
DROP TABLE IF EXISTS log_attributes3 SYNC;
DROP TABLE IF EXISTS log_attributes2 SYNC;

CREATE TABLE log_attributes3
(
    team_id Int32,
...
CREATE MATERIALIZED VIEW logs34_to_log_attributes3 TO log_attributes3
(
    team_id Int32,
    time_bucket DateTime64(0, 'UTC'),
...
CREATE MATERIALIZED VIEW logs34_to_resource_attributes3 TO log_attributes3
(
    team_id Int32,
    time_bucket DateTime64(0, 'UTC'),
    original_expiry_time_bucket DateTime64(0, 'UTC'),
